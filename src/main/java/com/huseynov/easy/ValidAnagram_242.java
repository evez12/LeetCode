...
//        String s = "anagram", t = "nagaram";
    ...
    public static boolean isAnagram2(String s, String t) {
        ...
        for (int i = 0; i < s.length(); i++) {
            int indexOfASCII = s.charAt(i); // a=>97,b=>98
            countOfChar[indexOfASCII - 97]++; // count of "a" in s = countOfChar[0], b=countOfChar[1]   ...;    a=0,b=1 ...
        }
        // if , I find "a" in t, then I must decrease to 1 unit,"a" suitable index in array
        for (int i = 0; i < t.length(); i++) {
            int indexOfASCII = t.charAt(i);
            countOfChar[indexOfASCII - 97]--;
        }
